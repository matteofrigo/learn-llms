...
## How it works
- `main.py` loads a `PromptRegistry`, creates a Mistral chat client, registers the `get_weather_data` tool into the agent, and runs the agent on “What's the weather like in Venezia?”.
